              ...
              <div key={item.id} style={{ background: "#fff", border: "1px solid #e8e0d4", borderLeft: `4px solid ${GOLD_MID}`, borderRadius: 6, overflow: "hidden" }}>
                <div style={{ padding: "14px 18px", display: "flex", alignItems: "flex-start", gap: 12 }}>
                  <div style={{ flex: 1 }}>
                    ...
                    {!isIdea && item.impact && (
                      <div style={{ border: "1px solid #d9ccba", borderRadius: 6, padding: "8px 10px", marginTop: 8, background: "#f7f6f3" }}>
                ...
                {isIdea && open && (
                  <div style={{ borderTop: "1px solid #f0e8de", padding: "14px 18px", background: "#f8f8f7", display: "flex", flexDirection: "column", gap: 10 }}>
                    {item.blockers && (
                      <div>
                    ...
                    {item.gaps && (
                      <div style={{ border: "2px solid #b42318", borderRadius: 0, padding: "8px 10px", background: "#fff5f5", width: "100%", boxSizing: "border-box" }}>
